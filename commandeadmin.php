...
$requete= "SELECT *, commande.idcom from commande inner join panier where commande.idcom=panier.id_commande group by commande.idcom";  
...
<tr>  
        ...
        <td><a href="valider.php?idcom=<?php  echo  $ligne["idcom"] ; ?> ">

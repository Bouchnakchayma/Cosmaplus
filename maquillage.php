    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li class="menu"><a href="#">Cheveux</a>
                    <ul class="submenu">
...
<?php
        ...
        ?>
        <a href="http://localhost/Mon%20site/ajouterpanier.php" class="panier"><i class="fa-solid fa-basket-shopping"></i></a>
    </header>
<?php
?>
<main>
    <section>
    <?php
$requete="select * from produits where catégoriepr='Maquillage'";

...
<?php
    ...
    <main>
        <img src="../Mon Site/image/978af596c014ad75e369b030e4de515602c45de0_sliders_web Revolution make up.jpg" alt=""
            class="image12">

        <h1 class="promo">Produits En Promotion</h1>    <section>
    <?php 
$serveur = "localhost";     
$utilisateur = "root"; 
$motDePasse = "";
...
$requete="select * from produits where typepr='En promotion'";
...
?>
            ...
            <div class="bloc">
                ...
                <div class="par">
                    <p class="p1">-15% </p>
                    <p class="p2">53 900 <sup>TND</sup> </p>
                    <p class="p3"><del><?php echo $ligne["prixpr"] ?></del> <sup>TND</sup> </p>
                </div> <br>
...
<?php  }?>
        ...
        <h1 class="promo">MEILLEURES VENTES</h1>
          <section> 
<?php
$requete="select * from produits where typepr='Meilleurs ventes'";
$resultat=$connexion->query($requete);
while ($ligne = $resultat->fetch_assoc()) {
?>
   <div class="bloc">
